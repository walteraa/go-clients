...
type Metadata interface {
	...
	List(bucket string, includeValue bool) (*MetadataListResponse, string, error)
...
func (cl *Client) List(bucket string, includeValue bool) (*MetadataListResponse, string, error) {
	const kind = "list"
